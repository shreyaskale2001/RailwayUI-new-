...
namespace RailwayReservationJWT.Controllers
{
    ...
    public class BookingController : ControllerBase
    {
        ...
        public BookingController(UserManager<IdentityUser> userManager, RailwayContext context, IEmailService emailService)
        {
        ...
        public async Task<IActionResult> Booking(TicketData ticketData)
        {
            ...
            if (userId != null)
            {
                ...
                if (ticket.TicketNo != 0)
                {
                    ...
                    //{
                    //    TicketID = ticket.TicketNo.ToString(),
                    //    PassengerName = ticket.UserName,
                    //    Age = ticket.Age.ToString(),
